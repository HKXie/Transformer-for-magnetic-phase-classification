...
if __name__ == '__main__':
    ...
    parser = configargparse.ArgumentParser(description='Vit_heisenberg_pahses_classification')
    ...
    parser.add_argument('--imgage_size', type=int, default=20,help='input image size')
    parser.add_argument('--imgage_patch', type=int, default=4,help='segmentation image patch')
    parser.add_argument('--channels', type=int, default=2, help='_')
    parser.add_argument('--num_class', type=int, default=2,help='num class')
    parser.add_argument('--mlp_dim', type=int, default=128, help='_')
